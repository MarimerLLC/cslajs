/// <reference path="../csla.js.tests/Scripts/typings/qunit/qunit.d.ts" />
declare var businessBaseTestsScope: {
    Csla: typeof Csla;
};
declare module SubclassTests {
    class Child extends Csla.Core.BusinessBase {
        private __childProp;
        private __grandchild;
    ...
    class Grandchild extends Child {
        private __grandchildProp;
        constructor(scope: Object, ctor: Function);
        create(parameters?: any): void;
        grandchildProp: string;
    }
}
declare var subclassTestsScope: {
    SubclassTests: typeof SubclassTests;
};
declare module Csla {
    module Reflection {
        /**
...
declare module Csla {
    module Core {
        ...
        class BusinessBase implements Serialization.IDeserialization, IEditableBusinessObject, IParent, ITrackStatus {
             ...
             */
            deserialize(obj: Object, scope: Object): void;
            /**
             ...
             */
            markDirty(suppressNotification?: boolean): void;
            /**
...
declare module Csla {
    module Core {
        ...
        class ServerDataPortal implements IDataPortal {
             ...
             * @returns A new {@link Csla.Core.BusinessBase} instance initialized via the data portal process.
             */
            createWithConstructor<T extends BusinessBase>(ctor: new (scope: Object, ctor: Function) => T, parameters?: Object): T;
            /**
             ...
             * @returns A new {@link Csla.Core.BusinessBase} instance initialized via the data portal process.
             */
            createWithIdentifier(classIdentifier: string, parameters?: Object): Object;
        }
    }
}
declare module Csla {
...
declare module Csla {
    module Serialization {
        class Serializer {
            ...
            deserialize<T extends Core.BusinessBase>(text: string, c: new (scope: Object, ctor: Function) => T, scope: Object): T;
        }
    }
}
