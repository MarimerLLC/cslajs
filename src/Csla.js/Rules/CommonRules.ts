...
module Csla {
  ...
  export module Rules {
    ...
    export interface IRuleFunction {
      (obj: Csla.Core.BusinessBase, primaryPropertyName: string, brokenRules: BrokenRule[], messageOrCallback?: any,
        ...args: any[]): boolean;
    }
    /**
    ...
    export class CommonRules {
      static requiredRule: IRuleFunction = (obj: Csla.Core.BusinessBase, primaryPropertyName: string, brokenRules: BrokenRule[],
        messageOrCallback?: any): boolean => {
      ...
      static maxLengthRule: IRuleFunction = (obj: Csla.Core.BusinessBase, primaryPropertyName: string, brokenRules: BrokenRule[],
        maxLength: number, messageOrCallback?: any): boolean => {
        var value = obj[primaryPropertyName];
